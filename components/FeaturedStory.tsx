      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <Link href="/newsletter/from-struggle-to-success" className="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 transition px-6 py-3 rounded-full text-white font-semibold">
              Read Full Story
